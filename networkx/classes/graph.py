...
import numpy as np    # FA 14/11/2022
...
class Graph:
    ...
    **Subclassing Example**
    ...
    def threshold(self, threshold, method='proportional'):  # FA 14-11-22
        
        weights = np.asarray([self.get_edge_data(u, v, default=None)['weight'] for u, v in self.edges])
        thr_weight = np.percentile(weights, threshold)
        edges_to_remove = [(u,v) for u, v in self.edges if self.get_edge_data(u, v, default=None)['weight'] < thr_weight] #weights > thr_weight
